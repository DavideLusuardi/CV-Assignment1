...
a free-viewpoint video system which enables the production of novel desirable camera views such as 
...
given a set of silhouettes from multiple views [2.2:8].
...
the captured multiple view video for rendering [2.2].
Due to accumulating errors in camera calibration and segmentation, visual-hull accuracy is reduced.
A refinement of the view-dependent visual hull (VDVH) [2.1:12]
...
More information about \textit{iview} 3D reconstruction can be found in [2,2.1,2.2].
